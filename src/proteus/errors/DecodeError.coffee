...
class DecodeError.InvalidType extends DecodeError
  constructor: (@message = 'Invalid type') ->

class DecodeError.InvalidArrayLen extends DecodeError
  constructor: (@message = 'Invalid array length') ->

class DecodeError.LocalIdentityChanged extends DecodeError
